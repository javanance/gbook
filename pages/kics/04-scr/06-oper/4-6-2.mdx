...
<iframe
  ...
  scrolling="no"
  title=""
  src="https://docs.google.com/spreadsheets/d/e/2PACX-1vS0XRomFHnFmSo7g5AGXULeCeBGUf4mrVYenxp2H2P7I7IMCOJ8lI8uX8m4fx90J6jPhlnD58ATQPYa/pubhtml?gid=940781545&amp;single=true&amp;widget=true&amp;headers=false">
</iframe>
</center>
...
- ①. 한도금액은 1년 전 시점의 보유계약을 기준으로 1년 간의 예상 지급금에 5%를 곱한 금액으로 한다.
- ②. 익스포져는 <OverlayDemo id="461_나"/> (2).1. 지급금예실차 익스포져에 따라 산출한 금액으로 한다.
- ③. 위험계수는 3.5를 적용한다.
...
- ①. 익스포져는 <OverlayDemo id="461_나"/>(2).2. 사업비예실차 익스포져에 따라 산출한 금액으로 한다.
- ②. 위험계수는 3.7을 적용한다.


<Accordion multiple activeIndex={[]}>
<AccordionTab header="기초가정위험액에 관한 개정사항의 시행 시기">
